...
import { X, ArrowDownLeft, Building2, CheckCircle2, CreditCard } from 'lucide-react';
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl max-w-lg w-full overflow-hidden shadow-xl animate-in fade-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="pt-2 flex items-center justify-end gap-2 border-t border-slate-100">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg shadow-xs text-xs transition flex items-center gap-1.5"
            >
