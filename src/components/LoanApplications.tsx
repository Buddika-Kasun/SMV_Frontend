      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-xl border border-slate-200/80 shadow-2xs">
        ...
        <div className="flex items-center gap-3 self-stretch sm:self-auto">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white font-medium px-3.5 py-2 rounded-lg text-xs transition shadow-xs shrink-0"
          >
                    ...
                    <td className="p-3.5 text-right overflow-hidden">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          className="p-1.5 text-slate-600 hover:text-blue-700 bg-slate-100 hover:bg-blue-50 rounded-lg transition shrink-0"
                          title="View Details"
                        >
                        ...
                        {isPendingApproval && (
                          canApprove ? (
                            <>
                              <button
                                onClick={() => onRejectLoanRequest(loan.id)}
                              ...
                              <button
                                onClick={() => onApproveLoanRequest(loan.id)}
                                className="flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white font-medium px-2.5 py-1 rounded-lg text-xs transition shadow-2xs shrink-0"
                            ...
                            >
                              ...
                              <span>Manager Approval Req.</span>
                            </span>
                          )
                        )}
                        ...
                        {isKycPending && (
                          <button
                            ...
                            className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white font-medium px-2.5 py-1 rounded-lg text-xs transition shadow-xs shrink-0"
                            title="Process KYC"
                          >
                        ...
                        {(isActive || isOverdue) && (
                          <>
                            <button
                              ...
                              className="px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[11px] font-medium transition shadow-2xs shrink-0"
                            >
                              Pay
                            </button>
                            <button
                              onClick={() => onOpenSettlement(loan)}
                              className="px-2 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-[11px] font-medium transition shrink-0"
                            >
                              Settle
                            </button>
                          </>
            ...
            return (
              ...
              >
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                  ...
                  <button
                    onClick={() => onSelectLoan(loan)}
                    className="px-2.5 py-1.5 text-slate-600 hover:text-blue-700 bg-slate-100/80 hover:bg-blue-50 rounded-lg transition text-xs font-medium flex items-center gap-1"
                  >
                    <Eye className="w-3.5 h-3.5" />
                    <span>Details</span>
                  </button>
                  ...
                  {isPendingApproval && (
                    canApprove ? (
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          onClick={() => onApproveLoanRequest(loan.id)}
                          className="flex items-center gap-1 bg-emerald-600 hover:bg-emerald-700 text-white font-medium px-3 py-1.5 rounded-lg text-xs transition shadow-2xs"
                        >
                          <CheckCircle className="w-3.5 h-3.5" />
                          <span>Approve</span>
                        </button>
                  ...
                  {isKycPending && (
                    <button
                      onClick={() => onTabChange('kyc')}
                      className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white font-medium px-3 py-1.5 rounded-lg text-xs transition shadow-xs"
                    >
                      <ShieldCheck className="w-3.5 h-3.5" />
                  ...
                  {(isActive || isOverdue) && (
                    <div className="flex items-center gap-1.5">
                      <button
                        onClick={() => onOpenPaymentModal(loan)}
                        className="px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium transition shadow-2xs"
                      >
                        Pay
                      </button>
                      <button
